...
// NB: les noms de colonnes ci-dessous sont déduits des routes API
// existantes (app/api/dashboard, app/api/analyze, app/api/actions/[id]/approve).
// Si tes vraies colonnes Supabase portent d'autres noms, ajuste les
// accès `row.xxx` correspondants ci-dessous.
